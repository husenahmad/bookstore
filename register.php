...
<head>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insertquery = "INSERT INTO regis (username, email, mobile, password) VALUES ('$username', '$email','$mobile', '$password')";
...
<body class="sub_page">
    ...
    <div class="container">
        ...
        <form action="" method="POST">
            <div class="first">
                <img src="images\username.png" class="img1" height="35px" ; width="35px" alt="">
                <input type="text" placeholder="Username" class="input" name="username" required>
            </div>
            <div class="second">
                <img src="images\email.png" class="img2" height="35px" ; width="35px" alt="">
                <input type="email" placeholder="Email Address" class="input" name="email" required>
            </div>
            <div class="third">
                <img src="images\phone.png" class="img3" height="33px" ; width="33px" alt="">
                <input type="text" placeholder="Mobile Number" maxlength="10" class="input" name="mobile" required>
            </div>
            <div class="fourth">
                <img src="images\password.png" class="img4" height="31px" ; width="45px" alt="">

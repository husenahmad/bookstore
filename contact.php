...
<head>
  ...
  if (isset($_POST['submit'])) {
    ...
    $insertquery = "INSERT INTO contactus (name, email, mobile, message) VALUES ('$name', '$email', '$mobile', '$message')";
      ...
      <div class="row">
        <div class="col-md-6 ">
          ...
          <form action="" method="POST">
            ...
            <div>
              <input type="text" placeholder="Phone Number" maxlength="10" name="mobile" required />
            </div>
            <div>
  ...
  <footer class="footer_section">
    <div class="container">
      <p>
        ...
        <a href="https://html.design/">Sunasara Husenahmad</a>
      </p>
    </div>
  </footer>
  <!-- footer section -->
